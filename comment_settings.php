                ...
                if($total != 0){
                        ...
                        while($result = mysqli_fetch_assoc($data)){
                            echo "<tr>
                                    ...
                                    <td>".$result['comMessage']."</td>
                                    <td>
                                    <a href='deletecomment.php?id=$result[id]'><button class='delete' onclick='return checkdelete()'><i class='fas fa-trash-alt'></i> Delete</button></a>
                                    </td>
                                </tr>";
                        }
                }

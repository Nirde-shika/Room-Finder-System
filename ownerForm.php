    ...
    <div class="container">
        ...
        <form id="registrationForm" action="#" method="POST">
            ...
            <div class="form">
                ...
                <div class="input_field">
                    <label>Address</label>
                    <textarea id="address" class="textarea" name="address" required><?php echo isset($_POST['address']) ? $_POST['address'] : ''; ?></textarea>
                </div>
...
if(isset($_POST['register']))
{
    ...
    // Validate fields
    if(empty($fname) || empty($lname) || empty($pwd) || empty($conpwd) || empty($gender) || empty($email) || empty($phone) || empty($address)) {
    ...
    if(count($errors) > 0) {
        ...
        $query = "INSERT INTO owner (O_fname, O_lname, O_password, O_cpassword, O_gender, O_email, O_contact, O_address) VALUES ('$fname', '$lname', '$pwd', '$conpwd', '$gender', '$email', '$phone', '$address')";

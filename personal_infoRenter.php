            ...
            <section class="contentdash">
                ...
                <div class="content-main">
                    <?php
                        ...
                        $query = "SELECT * FROM renter WHERE R_fname = '$name'";
                        $data = mysqli_query($conn, $query);
                        $result = mysqli_fetch_assoc($data);
                        echo "
                        <div class='property'>
                            <div class='property-row'>
                            <p class='property-label'>Name </p><p class='property-value'>".$result['R_fname']." ".$result['R_lname']."</p>
                            </div>
                            <div class='property-row'>
                                <p class='property-label'>Gender: </p><p class='property-value'>".$result['R_gender']."</p>
                            </div>
                            <div class='property-row'>
                                <p class='property-label'>Email </p><p class='property-value'>".$result['R_email']."</p>
                            </div>
                            <div class='property-row'>
                                <p class='property-label'>Contact </p><p class='property-value'>".$result['R_contact']."</p>
                            </div>
                            <div class='property-row'>
                                <p class='property-label'>Birthplace </p><p class='property-value'>".$result['R_birthplace']."</p>
                            </div>
                            <div class='property-row'>
                                <p class='property-label'>Address </p><p class='property-value'>".$result['R_currentAddress']."</p>
                            </div>

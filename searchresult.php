                ...
                <div class="content-main">
                    ...
                    <?php
                        if(isset($_POST['filter']))
                        {
                            ...
                            $minprice = $_POST['price_min'];
                            $maxprice = $_POST['price_max'];

                            // Build the query with dynamic conditions
                            $query = "SELECT * FROM room WHERE House_Address LIKE '%$location%'";
                            if (!empty($minprice)) {
                                $query .= " AND RoomPrice >= $minprice";
                            }
                            if (!empty($maxprice)) {
                                $query .= " AND RoomPrice <= $maxprice";
                            }
                            $query .= " ORDER BY Room_no DESC;";
